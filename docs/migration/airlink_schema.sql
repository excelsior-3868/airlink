...
--
-- Host: localhost    Database: airlink
-- ------------------------------------------------------
...
CREATE TABLE `company_wallet` (
  ...
  `balance_to_collect` int(11) DEFAULT NULL,
...
--
-- Table structure for table `ip_bindings`
--
...
--
-- Dumping data for table `ip_bindings`
--

LOCK TABLES `ip_bindings` WRITE;
/*!40000 ALTER TABLE `ip_bindings` DISABLE KEYS */;
/*!40000 ALTER TABLE `ip_bindings` ENABLE KEYS */;
UNLOCK TABLES;
...
(4,'2026_01_01_000001_create_reference_tables',1),
(5,'2026_01_01_000002_create_plans_table',1),
(6,'2026_01_01_000003_create_customers_table',1),
(7,'2026_01_01_000004_create_vouchers_table',1),
(8,'2026_01_01_000005_create_recharges_transactions_tables',1),
(9,'2026_01_01_000006_create_wallet_messaging_logs_tables',1),
(10,'2026_01_01_000007_create_radius_tables',1),
(11,'2026_06_15_163536_create_personal_access_tokens_table',1);
...
CREATE TABLE `plans` (
  ...
  `bandwidth_id` bigint(20) unsigned DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `type` enum('Hotspot','PPPOE') NOT NULL,
  `bandwidth_policy` enum('Unlimited','Limited') DEFAULT NULL,
  ...
  `router_name` varchar(32) NOT NULL DEFAULT '0',
  `pool` varchar(40) DEFAULT NULL,
  `access_control` int(11) NOT NULL DEFAULT 0,
  `data_usage_gb` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE `recharges` (
  ...
  `router_name` varchar(32) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `password` varchar(255) NOT NULL,
  `role` enum('admin','sales','regular','pos') NOT NULL DEFAULT 'regular',
  `access_control` varchar(20) NOT NULL DEFAULT '0',
...
(1,'admin','Administrator','admin@example.com',NULL,'$2y$12$MJIL4ZvjMfvXXPCU/IlJweBfROq6U4xXBUcEmoBB5jJeBkCO6kT5q','admin','0','active',NULL,NULL,NULL,'2026-06-15 17:52:36','2026-06-15 17:52:36');
...
CREATE TABLE `vouchers` (
  ...
  `allocation` varchar(200) DEFAULT '0',
...
CREATE TABLE `wallets` (
  ...
  `last_loaded_date` date DEFAULT NULL,
  `loaded_by` varchar(200) DEFAULT NULL,
  `last_collected_by` varchar(50) DEFAULT NULL,
  `last_registered_by` varchar(50) DEFAULT NULL,
  `legacy_id` bigint(20) unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2026-06-15 17:52:51
