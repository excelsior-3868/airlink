...
import { a as offset, c as useFloating$1, d as evaluate, f as max, h as isElement, l as autoUpdate, m as round, n as flip, o as shift, p as min, s as size, u as detectOverflow } from "./floating-ui.react-dom-BKcg9jz_.js";
		...
		if (r.dispose(), t.current === null) {
			t.current = s.currentTarget, l(!0);
			{
				...
				r.addEventListener(i, "pointerup", o, !1), r.addEventListener(i, "pointermove", (c) => {
					if (t.current) l(P$5(E$12(c), t.current.getBoundingClientRect()));
...
var A$3 = ((a) => (a[a.None = 0] = "None", a[a.RenderStrategy = 1] = "RenderStrategy", a[a.Static = 2] = "Static", a))(A$3 || {}), C$9 = ((t) => (t[t.Unmount = 0] = "Unmount", t[t.Hidden = 1] = "Hidden", t))(C$9 || {});
function K$2() {
	let e = I$8();
...
function D$10(e) {
	return "19.2.7".split(".")[0] >= "19" ? e.props.ref : e.ref;
}
function E$11(e) {
...
var _$8 = Y$3(C$7), M = Object.assign(_$8, {});
//#endregion
...
var j$6 = Y$3(U), Z = Object.assign(j$6, {});
//#endregion
...
var Virtualizer = class {
	constructor(opts) {
		...
		this.getMeasurements = memo(() => [this.getMeasurementOptions(), this.itemSizeCacheVersion], ({ count, paddingStart, scrollMargin, getItemKey, enabled, lanes, laneAssignmentMode }, _itemSizeCacheVersion) => {
		...
		this.resizeItem = (index, size) => {
			...
			if (delta !== 0) {
				...
				const shouldAdjustScroll = ((_b = this.scrollState) == null ? void 0 : _b.behavior) !== "smooth" && (this.shouldAdjustScrollPositionOnItemSizeChange !== void 0 ? this.shouldAdjustScrollPositionOnItemSizeChange(this.measurementsCache[index] ?? {
					...
					lane: 0
				}, delta, this) : itemStart < this.getScrollOffset() + this.scrollAdjustments && this.scrollDirection !== "backward");
...
function calculateRange({ measurements, outerSize, scrollOffset, lanes, flat }) {
	...
	if (lanes === 1) while (endIndex < lastIndex && getEnd(endIndex) < scrollOffset + outerSize) endIndex++;
	else if (lanes > 1) {
...
var S$6 = (t, e, r) => (v$6(t, typeof e != "symbol" ? e + "" : e, r), r), b$10 = (t, e, r) => {
	if (!e.has(t)) throw TypeError("Cannot " + r);
};
var i$8 = (t, e, r) => (b$10(t, e, "read from private field"), r ? r.call(t) : e.get(t)), c$16 = (t, e, r) => {
	if (e.has(t)) throw TypeError("Cannot add the same private member more than once");
	e instanceof WeakSet ? e.add(t) : e.set(t, r);
}, u$15 = (t, e, r, s) => (b$10(t, e, "write to private field"), s ? s.call(t, r) : e.set(t, r), r);
var n$7, a$18, o$9;
var T$7 = class {
	constructor(e) {
		c$16(this, n$7, {});
...
var f$12 = /* @__PURE__ */ new Map(), u$13 = /* @__PURE__ */ new Map();
function h$9(t) {
	var e;
...
].map((e) => `${e}:not([tabindex='-1'])`).join(","), S$4 = ["[data-autofocus]"].map((e) => `${e}:not([tabindex='-1'])`).join(",");
var T$6 = ((o) => (o[o.First = 1] = "First", o[o.Previous = 2] = "Previous", o[o.Next = 4] = "Next", o[o.Last = 8] = "Last", o[o.WrapAround = 16] = "WrapAround", o[o.NoScroll = 32] = "NoScroll", o[o.AutoFocus = 64] = "AutoFocus", o))(T$6 || {}), A$2 = ((n) => (n[n.Error = 0] = "Error", n[n.Overflow = 1] = "Overflow", n[n.Success = 2] = "Success", n[n.Underflow = 3] = "Underflow", n))(A$2 || {}), O$3 = ((t) => (t[t.Previous = -1] = "Previous", t[t.Next = 1] = "Next", t))(O$3 || {});
...
var _$4 = import_react.Fragment, I$4 = Y$3(function(o, l) {
...
var J = import_react.Fragment, c$5 = (0, import_react.createContext)(null);
function X$3(e, o) {
...
var k$8 = Y$3(D$5), B$3 = Y$3(X$3), le = Object.assign(k$8, { Group: B$3 });
//#endregion
...
var Do = "div", So = A$3.RenderStrategy | A$3.Static;
function Mo$1(T, O) {
	var M, Ce, ve;
...
var wo = Y$3(Ao), Bo = Y$3(Fo), ko = Y$3(Ro), No = Z, Uo = Y$3(Mo$1), Ho = Y$3(Vo), Ht = Object.assign(wo, {
	Input: ko,
	Button: Bo,
	Label: No,
	Options: Uo,
...
var ee$4 = Y$3(w$4), ge = Object.assign(ee$4, { features: G });
function te$3(o = !0) {
...
var de$2 = import_react.Fragment, fe$5 = A$3.RenderStrategy;
function Fe$4(e, t) {
	var ee, te;
...
var X$2 = Y$3(Ie$3), me$2 = Y$3(Fe$4), Oe = Y$3(Le$3), Ke$3 = Object.assign(X$2, {
	Child: Oe,
	Root: X$2
});
//#endregion
//#region ../node_modules/@headlessui/react/dist/components/dialog/dialog.js
var we$3 = ((o) => (o[o.Open = 0] = "Open", o[o.Closed = 1] = "Closed", o))(we$3 || {}), Be$2 = ((t) => (t[t.SetTitleId = 0] = "SetTitleId", t))(Be$2 || {});
var Ue$2 = { [0](e, t) {
	return e.titleId === t.id ? e : {
		...e,
		titleId: t.id
	};
} }, w$2 = (0, import_react.createContext)(null);
...
}), Ne$3 = "div", We$2 = A$3.RenderStrategy | A$3.Static;
function $e$1(e, t) {
...
var qe = Y$3($e$1), ze = Y$3(Ye), Lt = Y$3(Ke$4), Qe = Y$3(Ve$1), xt = M, ht = Object.assign(qe, {
	Panel: ze,
	Title: Qe,
	Description: M
});
...
var me$1 = ((l) => (l[l.Open = 0] = "Open", l[l.Closed = 1] = "Closed", l))(me$1 || {}), fe$3 = ((n) => (n[n.ToggleDisclosure = 0] = "ToggleDisclosure", n[n.CloseDisclosure = 1] = "CloseDisclosure", n[n.SetButtonId = 2] = "SetButtonId", n[n.SetPanelId = 3] = "SetPanelId", n[n.SetButtonElement = 4] = "SetButtonElement", n[n.SetPanelElement = 5] = "SetPanelElement", n))(fe$3 || {});
var De$2 = {
	[0]: (e) => ({
		...e,
	...
	let D = o$14((i) => {
		...
		if (s) {
			...
			switch (i.key) {
				case o$10.Space:
				case o$10.Enter:
					i.preventDefault(), i.stopPropagation(), r({ type: 0 }), (g = o.buttonElement) == null || g.focus();
					break;
			}
		} else switch (i.key) {
			case o$10.Space:
...
var be = "div", Ce$3 = A$3.RenderStrategy | A$3.Static;
function Re$1(e, t) {
...
var Ie$2 = Y$3(Se$3), xe = Y$3(Ae$2), Le = Y$3(Re$1), Xe = Object.assign(Ie$2, {
	Button: xe,
	Panel: Le
});
//#endregion
...
var F = ((t) => (t[t.Open = 0] = "Open", t[t.Closed = 1] = "Closed", t))(F || {}), P$1 = ((t) => (t[t.Single = 0] = "Single", t[t.Multi = 1] = "Multi", t))(P$1 || {}), C$2 = ((t) => (t[t.Pointer = 0] = "Pointer", t[t.Other = 1] = "Other", t))(C$2 || {}), k$3 = ((r) => (r[r.OpenListbox = 0] = "OpenListbox", r[r.CloseListbox = 1] = "CloseListbox", r[r.GoToOption = 2] = "GoToOption", r[r.Search = 3] = "Search", r[r.ClearSearch = 4] = "ClearSearch", r[r.SelectOption = 5] = "SelectOption", r[r.RegisterOptions = 6] = "RegisterOptions", r[r.UnregisterOptions = 7] = "UnregisterOptions", r[r.SetButtonElement = 8] = "SetButtonElement", r[r.SetOptionsElement = 9] = "SetOptionsElement", r[r.SortOptions = 10] = "SortOptions", r[r.MarkButtonAsMoved = 11] = "MarkButtonAsMoved", r))(k$3 || {});
	...
	let h = o$14((r) => {
		switch (r.key) {
			...
			case o$10.ArrowDown:
				...
				break;
			case o$10.ArrowUp:
				r.preventDefault(), a.actions.openListbox({ focus: s.value ? c$8.Nothing : c$8.Last });
				break;
		}
	}), I = o$14((r) => {
		switch (r.key) {
...
var Oe$3 = (0, import_react.createContext)(!1), ht$2 = "div", At$1 = A$3.RenderStrategy | A$3.Static;
function _t$1(b, E) {
...
var Ct$1 = Y$3(gt$2), Mt = Y$3(Et$2), wt = Z, Bt = Y$3(_t$1), It = Y$3(Dt$1), kt = Y$3(Ft$1), Mo = Object.assign(Ct$1, {
	Button: Mt,
	Label: wt,
	Options: Bt,
	Option: It,
...
var nt = "div", rt = A$3.RenderStrategy | A$3.Static;
function at(m, y) {
...
var ct = Y$3(et), ft = Y$3(ot), yt = Y$3(at), gt = Y$3(lt), Pt = Y$3(it), Et = Y$3(mt$1), Mt$1 = Y$3(Tt$1), lo = Object.assign(ct, {
	Button: ft,
	Items: yt,
	Item: gt,
	Section: Pt,
...
var v$1 = ((e) => (e[e.Open = 0] = "Open", e[e.Closed = 1] = "Closed", e))(v$1 || {}), h$1 = ((r) => (r[r.OpenPopover = 0] = "OpenPopover", r[r.ClosePopover = 1] = "ClosePopover", r[r.SetButton = 2] = "SetButton", r[r.SetButtonId = 3] = "SetButtonId", r[r.SetPanel = 4] = "SetPanel", r[r.SetPanelId = 5] = "SetPanelId", r))(h$1 || {});
var E$2 = {
...
var yt$2 = "div", gt$1 = A$3.RenderStrategy | A$3.Static;
function Ne$2(E, O) {
...
var Rt = "div", Ft = A$3.RenderStrategy | A$3.Static;
function Bt$1(E, O) {
...
var Ct = Y$3(Tt), Dt = Y$3(bt), Ot = Y$3(Ne$2), xt$1 = Y$3(Ne$2), Lt$1 = Y$3(Bt$1), ht$1 = Y$3(_t), vo = Object.assign(Ct, {
	Button: Dt,
	Backdrop: xt$1,
	Overlay: Ot,
	Panel: Lt$1,
...
var Be$1 = Y$3(Se$1), Ve = Y$3(He$1), Ke$1 = Y$3(We$1), $e = Z, je = M, yt$1 = Object.assign(Be$1, {
	Option: Ve,
	Radio: Ke$1,
	Label: $e,
	Description: je
...
var Re = Y$3(Le$2), Ge = xe$1, Ae = Z, Fe = M, tt = Object.assign(Re, {
	Group: Ge,
	Label: Ae,
	Description: Fe
});
...
var Le$1 = ((t) => (t[t.Forwards = 0] = "Forwards", t[t.Backwards = 1] = "Backwards", t))(Le$1 || {}), _e = ((l) => (l[l.Less = -1] = "Less", l[l.Equal = 0] = "Equal", l[l.Greater = 1] = "Greater", l))(_e || {}), Se = ((n) => (n[n.SetSelectedIndex = 0] = "SetSelectedIndex", n[n.RegisterTab = 1] = "RegisterTab", n[n.UnregisterTab = 2] = "UnregisterTab", n[n.RegisterPanel = 3] = "RegisterPanel", n[n.UnregisterPanel = 4] = "UnregisterPanel", n))(Se || {});
var De = {
	[0](e, r) {
		var d;
...
var we = "div", Oe$1 = A$3.RenderStrategy | A$3.Static;
function Ne(e, r) {
	var R, A, L, _;
...
var ke = Y$3(Ge$1), Be = Y$3(he), We = Y$3(Ce), je$1 = Y$3(He), Ke$2 = Y$3(Ne), dt = Object.assign(ke, {
	Group: Be,
	List: We,
	Panels: je$1,
	Panel: Ke$2
